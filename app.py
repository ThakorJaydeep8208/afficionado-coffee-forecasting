...
@st.cache_data
def load_data():
   df = pd.read_csv("https://raw.githubusercontent.com/ThakorJaydeep8208/afficionado-coffee-forecasting/main/Afficionado Coffee Roasters.xlsx - Transactions.csv")
